...
(() => {
  var t = {
      ...
      72: (t) => {
        ...
        function i(t, i) {
          for (var r = {}, a = [], s = 0; s < t.length; s++) {
            ...
            if (-1 !== d) e[d].references++, e[d].updater(f);
              ...
              var p = o(f, i);
              (i.byIndex = s),
                e.splice(s, 0, { identifier: h, updater: p, references: 1 });
            }
            a.push(h);
          }
          return a;
        ...
        t.exports = function (t, o) {
          ...
          return function (t) {
            ...
            for (var l = i(t, o), u = 0; u < r.length; u++) {
              var c = n(r[u]);
      ...
      184: (t, e, n) => {
        "use strict";
        t.exports = n.p + "bf804537a8c269bb5df0.png";
      },
      314: (t) => {
        "use strict";
        t.exports = function (t) {
      ...
      353: (t, e, n) => {
        "use strict";
        t.exports = n.p + "83e70a079ed6ad01f44d.png";
      },
      417: (t) => {
        "use strict";
        t.exports = function (t, e) {
      ...
      481: function (t, e) {
        !(function (t) {
          ...
          var x =
              window.requestAnimationFrame || y("RequestAnimationFrame") || w,
            E =
                ...
                if (1 !== arguments.length)
                  if ("function" == typeof e) {
                    ...
                    if (!1 !== a) {
                      var s = i[a];
                      this._firingCount &&
                        ((s.fn = l), (this._events[t] = i = i.slice())),
                        i.splice(a, 1);
                    }
                  } else console.warn("wrong listener type: " + typeof e);
                else {
              ...
              if (this._events) {
                ...
                if (r) {
                  ...
                  for (var a = 0, s = r.length; a < s; a++) {
                    var l = r[a],
                      u = l.fn;
                    l.once && this.off(t, u, l.ctx), u.call(l.ctx || this, o);
                  }
                  this._firingCount--;
                }
              }
          ...
          (C.prototype = {
            ...
            (j.prototype = {
              ...
              contains: function (t) {
                ...
                return (
                  (t =
                    "number" == typeof t[0] || t instanceof C
                      ? A(t)
                      : I(t)) instanceof j
                    ? ((e = t.min), (n = t.max))
                    : (e = n = t),
              ...
              pad: function (t) {
                ...
                return I(A(e.x - i, e.y - o), A(n.x + i, n.y + o));
              },
              equals: function (t) {
                return (
                  !!t &&
            ...
            (B.prototype = {
              extend: function (t) {
                ...
                if (t instanceof Z) (e = t), (n = t);
                  ...
                  if (!(t instanceof B))
                    return t ? this.extend(N(t) || R(t)) : this;
              ...
              pad: function (t) {
                ...
                return new B(
                  new Z(e.lat - i, e.lng - o),
                  new Z(n.lat + i, n.lng + o)
                );
              },
              getCenter: function () {
                return new Z(
          ...
          var D,
            F = {
              ...
              wrapLatLngBounds: function (t) {
                ...
                var r = t.getSouthWest(),
                  a = t.getNorthEast();
                return new B(
                  new Z(r.lat - i, r.lng - o),
                  new Z(a.lat - i, a.lng - o)
                );
              },
            },
            U = e({}, F, {
            ...
            G = {
              ...
              bounds: ((D = H * Math.PI), new j([-D, -D], [D, D])),
            };
          function W(t, e, n, i) {
            if (g(t))
              return (
          ...
          var X,
            ...
            at = it && At("Google") && rt < 537 && !("AudioNode" in window),
            st = !!window.opera,
            lt = !et && At("chrome"),
            ut = At("gecko") && !nt && !st && !Q,
            ct = !lt && At("safari"),
            ...
            _t = !window.L_DISABLE_3D && (pt || mt || gt) && !dt && !ht,
            ...
            Ct =
              ...
              "http://www.w3.org/2000/svg" ===
                (X.firstChild && X.firstChild.namespaceURI)),
            Mt =
              !zt &&
              (function () {
                try {
          ...
          var jt = {
            ...
            It = jt.msPointer ? "MSPointerDown" : "pointerdown",
            Bt = jt.msPointer ? "MSPointerMove" : "pointermove",
            Rt = jt.msPointer ? "MSPointerUp" : "pointerup",
            Zt = jt.msPointer ? "MSPointerCancel" : "pointercancel",
            Nt = {
              touchstart: It,
              touchmove: Bt,
              touchend: Rt,
          ...
          function Ht(t, e, n) {
            return (
              "touchstart" === e &&
                (Ut ||
                  (document.addEventListener(It, Gt, !0),
          ...
          if ("onselectstart" in document)
            (Kt = function () {
              Te(window, "selectstart", Re);
            }),
              (Jt = function () {
                Oe(window, "selectstart", Re);
              });
          else {
            var ye = me([
              "userSelect",
            ...
            (Kt = function () {
              ...
              (Jt = function () {
                ye &&
                  ((document.documentElement.style[ye] = Yt), (Yt = void 0));
              });
          }
          function be() {
            Te(window, "dragstart", Re);
          }
          function we() {
            Oe(window, "dragstart", Re);
          }
          function xe(t) {
          ...
          function Te(t, e, n, i) {
            if (e && "object" == typeof e) for (var o in e) Me(t, o, e[o], n);
            else
          ...
          function Oe(t, e, n, i) {
            if (1 === arguments.length) ze(t), delete t[Se];
            ...
            else for (var r = 0, a = e.length; r < a; r++) Ae(t, e[r], n, i);
            return this;
          }
          function ze(t, e) {
            for (var n in t[Se]) {
              var i = n.split(/\d/)[0];
              (e && !e(i)) || Ae(t, i, null, null, n);
            }
          }
          var Ce = {
          ...
          function Ae(t, e, n, i, o) {
            ...
            !jt.touchNative && jt.pointer && 0 === e.indexOf("touch")
              ? (function (t, e, n) {
                  Nt[e]
                    ? t.removeEventListener(Nt[e], n, !1)
              ...
              ? t.removeEventListener(Ce[e] || e, a, !1)
          ...
          function Ie(t) {
            return Me(t, "wheel", je), this;
          }
          function Be(t) {
            return (
              Te(t, "mousedown touchstart dblclick contextmenu", je),
          ...
          var Ge = {
            ...
            We = z.extend({
              ...
              _runFrame: function (t, e) {
                ...
                e && n._round(), _e(this._el, n), this.fire("step");
              },
              _complete: function () {
            ...
            qe = z.extend({
              ...
              setView: function (t, n, i) {
                return (
                  ...
                  (t = this._limitCenter(N(t), n, this.options.maxBounds)),
                  (i = i || {}),
                  this._stop(),
                  this._loaded &&
                  !i.reset &&
              ...
              setZoomAround: function (t, e, n) {
                var i = this.getZoomScale(e),
                  ...
                  r = (t instanceof C ? t : this.latLngToContainerPoint(t))
                    .subtract(o)
                    .multiplyBy(1 - 1 / i),
                  ...
                  function n() {
                    ...
                    r <= 1
                      ? ((this._flyToFrame = P(n, this)),
                        this._move(
                          this.unproject(
                            i.add(o.subtract(i).multiplyBy(g(l) / u)),
                            a
                          ),
                          this.getScaleZoom(
                            s /
              ...
              panInside: function (t, e) {
                var n = A((e = e || {}).paddingTopLeft || e.padding || [0, 0]),
                  ...
                  s = I([a.min.add(n), a.max.subtract(i)]),
                  l = s.getSize();
                if (!s.contains(r)) {
                  this._enforcingBounds = !0;
              ...
              getBoundsZoom: function (t, e, n) {
                ...
                var i = this.getZoom() || 0,
                  ...
                  u = I(this.project(s, i), this.project(a, i)).getSize(),
                  c = jt.any3d ? this.options.zoomSnap : 1,
                  h = l.x / u.x,
                  d = l.y / u.y,
              ...
              _getMapPanePos: function () {
                return ve(this._mapPane) || new C(0, 0);
              },
              _moved: function () {
                var t = this._getMapPanePos();
              ...
              _limitZoom: function (t) {
                var e = this.getMinZoom(),
                  n = this.getMaxZoom(),
                  i = jt.any3d ? this.options.zoomSnap : 1;
                return (
          ...
          var Je = Ve.extend({
              ...
              addTo: function (t) {
                return (
                  Ve.prototype.addTo.call(this, t), this._expandIfNotCollapsed()
                );
              },
              onRemove: function () {
              ...
              _expandSafely: function () {
                var t = this._section;
                (this._preventClick = !0), Te(t, "click", Re), this.expand();
                var e = this;
                setTimeout(function () {
                  Oe(t, "click", Re), (e._preventClick = !1);
                });
              },
            }),
            Ye = Ve.extend({
          ...
          var tn = { Events: O },
            en = jt.touch ? "touchstart mousedown" : "mousedown",
            nn = z.extend({
                ...
                if (this._enabled)
                  if (t.touches && t.touches.length > 1) this._moved = !0;
                    ...
                    var e =
                      ...
                      n = new C(e.clientX, e.clientY)._subtract(
                        this._startPoint
                      );
                    (n.x || n.y) &&
            ...
            for (a = 0; a < 4; a++) {
              for (
                ...
                (s = t[o]),
                  ...
                  s._code & c
                    ? l._code & c ||
                      (((h = fn(l, s, c, e, n))._code = pn(h, e)), i.push(h))
                    : (l._code & c &&
                        (((h = fn(l, s, c, e, n))._code = pn(h, e)), i.push(h)),
                      i.push(s));
              t = i;
          ...
          function rn(t, e) {
            ...
            for (n = 0; n < f; n++) {
              var m = N(t[n]);
              p.push(e.project(N([m.lat - h.lat, m.lng - h.lng])));
            }
            for (s = l = u = 0, n = 0, i = f - 1; n < f; i = n++)
              (o = p[n]),
                ...
                (s += 3 * a);
            c = 0 === s ? p[0] : [l / s, u / s];
            var g = e.unproject(A(c));
            return N([g.lat + h.lat, g.lng + h.lng]);
          }
          function an(t) {
          ...
          function hn(t, e, n, i, o) {
            var r,
              ...
              l = 0;
            for (a = i + 1; a <= o - 1; a++)
              (s = gn(t[a], t[i], t[o], !0)) > l && ((r = a), (l = s));
            l > n && ((e[r] = 1), hn(t, e, n, i, r), hn(t, e, n, r, o));
          }
          ...
          function yn(t, e) {
            ...
            for (n = 0; n < d; n++) {
              var p = N(t[n]);
              f.push(e.project(N([p.lat - c.lat, p.lng - c.lng])));
            }
            for (n = 0, i = 0; n < d - 1; n++)
              i += f[n].distanceTo(f[n + 1]) / 2;
            if (0 === i) u = f[0];
            else
              for (n = 0, r = 0; n < d - 1; n++)
                if (
                  ((a = f[n]), (s = f[n + 1]), (r += o = a.distanceTo(s)) > i)
                ) {
                  (l = (r - i) / o),
                    (u = [s.x - l * (s.x - a.x), s.y - l * (s.y - a.y)]);
                  break;
                }
            var m = e.unproject(A(u));
            return N([m.lat + c.lat, m.lng + c.lng]);
          }
          var bn = {
              __proto__: null,
              simplify: un,
          ...
          var Cn = zn.extend({
              ...
              _getIconUrl: function (t) {
                return (
                  "string" != typeof Cn.imagePath &&
                    (Cn.imagePath = this._detectIconPath()),
            ...
            An = Tn.extend({
              ...
              _initIcon: function () {
                ...
                n !== this._icon &&
                  ...
                  this.options.autoPanOnFocus &&
                    Te(n, "focus", this._panOnFocus, this);
              ...
              _removeIcon: function () {
                this.options.riseOnHover &&
                  ...
                  this.options.autoPanOnFocus &&
                    Oe(this._icon, "focus", this._panOnFocus, this),
                  re(this._icon),
          ...
          var jn = Tn.extend({
            ...
            In = jn.extend({
              ...
              setStyle: function (t) {
                ...
                return (
                  jn.prototype.setStyle.call(this, t), this.setRadius(e), this
                );
              },
              _project: function () {
          ...
          var Rn = jn.extend({
            ...
            getCenter: function () {
              ...
              return yn(this._defaultShape(), this._map.options.crs);
            },
            getBounds: function () {
              return this._bounds;
            },
            ...
            _convertLatLngs: function (t) {
              for (var e = [], n = _n(t), i = 0, o = t.length; i < o; i++)
                n
            ...
            _containsPoint: function (t, e) {
              ...
              for (n = 0, r = this._parts.length; n < r; n++)
                for (
                  ...
                  if ((e || 0 !== i) && cn(t, s[o], s[i]) <= l) return !0;
              return !1;
            },
          });
          Rn._flat = vn;
          var Zn = Rn.extend({
            ...
            _setLatLngs: function (t) {
              Rn.prototype._setLatLngs.call(this, t),
                ...
                for (
                  ...
                  (n = e[r]),
                    ...
                    n.y > t.y != i.y > t.y &&
                      ...
                      (u = !u);
              return u || Rn.prototype._containsPoint.call(this, t, !0);
            },
          });
          var Nn = On.extend({
            initialize: function (t, e) {
          ...
          function Dn(t, e) {
            var n,
              ...
              l = [],
              u = e && e.pointToLayer,
              c = (e && e.coordsToLatLng) || Un;
            if (!s && !a) return null;
            switch (a.type) {
              case "Point":
                return Fn(u, t, (n = c(s)), e);
              case "MultiPoint":
                for (o = 0, r = s.length; o < r; o++)
                  (n = c(s[o])), l.push(Fn(u, t, n, e));
                return new On(l);
              case "LineString":
              case "MultiLineString":
                return (
                  (i = Hn(s, "LineString" === a.type ? 0 : 1, c)), new Rn(i, e)
                );
              case "Polygon":
              case "MultiPolygon":
                return (
                  (i = Hn(s, "Polygon" === a.type ? 1 : 2, c)), new Zn(i, e)
                );
              ...
              case "FeatureCollection":
                for (o = 0, r = a.features.length; o < r; o++) {
                  var d = Dn(a.features[o], e);
                  d && l.push(d);
                }
                return new On(l);
              default:
          ...
          function Hn(t, e, n) {
            for (var i, o = [], r = 0, a = t.length; r < a; r++)
              (i = e ? Hn(t[r], e - 1, n) : (n || Un)(t[r])), o.push(i);
            return o;
          }
          function Gn(t, e) {
          ...
          function Wn(t, e, n, i) {
            for (var o = [], r = 0, a = t.length; r < a; r++)
              o.push(e ? Wn(t[r], _n(t[r]) ? 0 : e - 1, n, i) : Gn(t[r], i));
          ...
          var Kn = {
            toGeoJSON: function (t) {
              return qn(this, {
                type: "Point",
                coordinates: Gn(this.getLatLng(), t),
              });
            },
          };
          function Jn(t, e) {
            ...
            Sn.include({
              toMultiPoint: function (t) {
                ...
                return (
                  ...
                  qn(this, { type: "MultiPoint", coordinates: e })
                );
              },
              toGeoJSON: function (t) {
                var e =
                ...
                return (
                  ...
                  n
                    ? qn(this, { geometries: i, type: "GeometryCollection" })
          ...
          var Yn = Jn,
            Xn = Tn.extend({
              ...
              initialize: function (t, e, n) {
                (this._url = t), (this._bounds = R(e)), d(this, n);
              },
              onAdd: function () {
                this._image ||
                  (this._initImage(),
          ...
          var ti = Tn.extend({
            ...
            initialize: function (t, e) {
              t && (t instanceof Z || g(t))
                ? ((this._latlng = N(t)), d(this, e))
          ...
          var ei = ti.extend({
            ...
            onAdd: function (t) {
              ti.prototype.onAdd.call(this, t),
                ...
                this._source &&
                  ...
                  this._source instanceof jn ||
                    this._source.on("preclick", je));
            },
            onRemove: function (t) {
            ...
            _updateLayout: function () {
              ...
              o && i > o ? ((e.height = o + "px"), ce(t, r)) : he(t, r),
              ...
              if (this.options.autoPan)
                if (
                  ...
                  var t = this._map,
                    ...
                    o = new C(this._containerLeft, -n - this._containerBottom);
          ...
          qe.mergeOptions({ closePopupOnClick: !0 }),
            ...
            Tn.include({
              bindPopup: function (t, e) {
                return (
                  (this._popup = this._initOverlay(ei, this._popup, t, e)),
              ...
              _openPopup: function (t) {
                if (this._popup && this._map) {
                  ...
                  this._popup._source !== e || e instanceof jn
            ...
            Tn.include({
              bindTooltip: function (t, e) {
                return (
                  ...
                  (this._tooltip = this._initOverlay(ni, this._tooltip, t, e)),
            ...
            _setZoomTransform: function (t, e, n) {
              var i = this._map.getZoomScale(n, t.zoom),
                o = t.origin
                  ...
                  .round();
              jt.any3d ? ge(t.el, o, i) : _e(t.el, o);
            },
            _resetGrid: function () {
              var t = this._map,
                e = t.options.crs,
              ...
              if (e) {
                ...
                if (
                  ...
                  for (var u in this._tiles) {
                    ...
                    (c.z === this._tileZoom && l.contains(new C(c.x, c.y))) ||
          ...
          var ri = oi.extend({
            ...
            initialize: function (t, e) {
              (this._url = t),
                (e = d(this, e)).detectRetina && jt.retina && e.maxZoom > 0
            ...
            createTile: function (t, e) {
              ...
              return (
                Te(n, "load", i(this._tileOnLoad, this, e, n)),
                Te(n, "error", i(this._tileOnError, this, e, n)),
            ...
            _tileOnLoad: function (t, e) {
              jt.ielt9 ? setTimeout(i(t, this, null, e), 0) : t(null, e);
            },
          ...
          var si = ri.extend({
            ...
            initialize: function (t, n) {
              ...
              var r = (n = d(this, n)).detectRetina && jt.retina ? 2 : 1,
                a = this.getTileSize();
            ...
            getTileUrl: function (t) {
              var e = this._tileCoordsToNwSe(t),
                ...
                s = ri.prototype.getTileUrl.call(this, t);
              return (
                s +
          ...
          var li = Tn.extend({
              ...
              _updateTransform: function (t, e) {
                ...
                jt.any3d ? ge(this._container, r, n) : _e(this._container, r);
              },
              _reset: function () {
          ...
          function ci(t) {
            return jt.canvas ? new ui(t) : null;
          }
          var hi = (function () {
              try {
                return (
            ...
            di = {
              ...
              _update: function () {
                this._map._animatingZoom ||
                  (li.prototype._update.call(this), this.fire("update"));
              },
              _initPath: function (t) {
          ...
          function mi(t) {
            return jt.svg || jt.vml ? new pi(t) : null;
          }
          jt.vml && pi.include(di),
            qe.include({
          ...
          (pi.create = fi),
            (pi.pointsToPath = Y),
            (Nn.geometryToLayer = Dn),
            (Nn.coordsToLatLng = Un),
            (Nn.coordsToLatLngs = Hn),
            (Nn.latLngToCoords = Gn),
            (Nn.latLngsToCoords = Wn),
            (Nn.getFeature = qn),
            (Nn.asFeature = Vn),
          ...
          qe.addInitHook("addHandler", "doubleClickZoom", vi),
            qe.mergeOptions({
              dragging: !0,
              inertia: !0,
          ...
          qe.addInitHook("addHandler", "dragging", yi),
                ...
                if (n in this._panKeys) {
                  if (!i._panAnim || !i._panAnim._inProgress)
                    if (
                      ...
                      i.options.maxBounds &&
                        (e = i._limitOffset(A(e), i.options.maxBounds)),
          ...
          qe.addInitHook("addHandler", "keyboard", bi),
            qe.mergeOptions({
              scrollWheelZoom: !0,
          ...
          qe.addInitHook("addHandler", "scrollWheelZoom", wi);
          qe.mergeOptions({
          ...
          var xi = Qe.extend({
            ...
            _cancelClickPrevent: function t() {
              Oe(document, "touchend", Re),
                Oe(document, "touchend touchcancel", t);
            },
            _cancel: function () {
          ...
          qe.addInitHook("addHandler", "tapHold", xi),
            qe.mergeOptions({ touchZoom: jt.touch, bounceAtZoomLimits: !0 });
          var Ei = Qe.extend({
            addHooks: function () {
            ...
            _onTouchMove: function (t) {
              if (t.touches && 2 === t.touches.length && this._zooming) {
                ...
                (this._animRequest = P(s, this, !0)), Re(t);
              }
            },
          ...
          qe.addInitHook("addHandler", "touchZoom", Ei),
            (qe.BoxZoom = _i),
            (qe.DoubleClickZoom = vi),
            (qe.Drag = yi),
            (qe.Keyboard = bi),
            (qe.ScrollWheelZoom = wi),
            (qe.TapHold = xi),
            (qe.TouchZoom = Ei),
            (t.Bounds = j),
            (t.Browser = jt),
      ...
      536: (t, e, n) => {
        "use strict";
        t.exports = n.p + "78ea8c65cea28287bd90.png";
      },
      540: (t) => {
        "use strict";
        t.exports = function (t) {
  ...
  (n.m = t),
    ...
    (() => {
          ...
          (e = [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                t.forEach(function (t) {
                  var n = new Date(t.createdAt).toLocaleString(),
                    i =
                      '\n        <div class="story-card" tabindex="0">\n          <img src="'
                        .concat(t.photoUrl, '" alt="')
                        .concat(t.name, '" />\n          <h3>')
                        .concat(t.name, "</h3>\n          <p>")
                        .concat(
                          t.description,
                          '</p>\n          <small style="margin: 0 1rem; color: gray;">📅 '
                        )
                        .concat(
                          n,
            ...
            },
            {
              ...
              value: function () {
                ...
                if (t) {
                  var e = t.querySelector('.story-card[tabindex="0"]');
                  e && e.focus();
                }
              },
            },
            {
              key: "addDetailEventListeners",
              value: function () {
                document.querySelectorAll(".detail-btn").forEach(function (t) {
                  t.addEventListener("click", function (t) {
                    var e = t.target.getAttribute("data-id");
                    window.viewStoryDetail(e);
                  });
                });
              },
            },
          ...
          (e = [
            {
              ...
              value: function (t) {
                var e = this,
                  n = new Date(t.createdAt).toLocaleString(),
                  i =
                    '\n      <div class="popup-card">\n        <button class="popup-close" aria-label="Tutup detail">✖</button>\n        <img src="'
                      .concat(t.photoUrl, '" alt="photo" />\n        <h2>')
                      .concat(
                        t.name,
                ...
                if (
                  ((this.popupContainer.innerHTML = i),
                  ...
                  var o = window.location.pathname.split("/")[1],
                    r = document.querySelector("#popup-map");
                  if (
                    (L.Icon.Default.mergeOptions({
                      iconRetinaUrl: "".concat(o, "images/marker-icon-2x.png"),
                      iconUrl: "".concat(o, "images/marker-icon.png"),
                      shadowUrl: "".concat(o, "images/marker-shadow.png"),
                    }),
                    r)
                  ) {
                    var a = L.map(r).setView([t.lat, t.lon], 13);
                    L.tileLayer(
                      "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                    ).addTo(a);
                    var s = L.marker([t.lat, t.lon]).addTo(a);
                    s.bindPopup("<b>".concat(t.name, "</b>"));
                    var l = "https://nominatim.openstreetmap.org/reverse?lat="
                      .concat(t.lat, "&lon=")
                      .concat(t.lon, "&format=json&addressdetails=1");
                    fetch(l)
                      .then(function (t) {
                        return t.json();
                      })
                      .then(function (e) {
                        var n = e.address,
                          i =
                            (n && (n.city || n.town || n.village)) ||
                            "Unknown Location";
                        s.bindPopup(
                          "<b>".concat(t.name, "</b><br/>Location: ").concat(i)
                        );
                      })
                      .catch(function (e) {
                        console.error("Geocoding error:", e),
                          s.bindPopup(
                            "<b>".concat(t.name, "</b><br/>Location: Unknown")
                          );
                      });
                  }
                }
      ...
      function S() {
                ...
                return function (r, a) {
                  ...
                  for (i.method = r, i.arg = a; ; ) {
                    ...
                    if ("next" === i.method) i.sent = i._sent = i.arg;
                      ...
                      if (1 === o) throw ((o = 4), i.arg);
                      i.dispatchException(i.arg);
                    } else "return" === i.method && i.abrupt("return", i.arg);
                    o = 3;
                    var u = c(e, n, i);
                    if ("normal" === u.type) {
                      if (((o = i.done ? 4 : 2), u.arg === h)) continue;
                      return { value: u.arg, done: i.done };
                    }
                    "throw" === u.type &&
                      ((o = 4), (i.method = "throw"), (i.arg = u.arg));
                  }
                };
              })(e, i, new P(o || [])),
              !0
        ...
        function P(t) {
          (this.tryEntries = [[-1]]), t.forEach(x, this), this.reset(!0);
        }
        function k(e) {
          if (null != e) {
            var n = e[r];
          ...
          (P.prototype = {
            ...
            dispatchException: function (e) {
              ...
              for (var o = n.tryEntries.length - 1; o >= 0; --o) {
                ...
                if (null != r[0] && r[0] <= s) {
                  if (s < l)
                    return (this.method = "next"), (this.arg = t), i(l), !0;
                  if (s < u) return i(u), !1;
                }
              }
            },
            abrupt: function (t, e) {
              ...
              return (
                ...
                (r.arg = e),
                o
                  ? ((this.method = "next"), (this.next = o[2]), h)
                  : this.complete(r)
              );
            },
            ...
            finish: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                if (n[2] === t) return this.complete(n[4], n[3]), E(n), h;
              }
            },
            catch: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 9:
                              ...
                              return t.abrupt("return", o.listStory || []);
                            case 14:
                              return (
                                console.error(
                            ...
                            case 18:
                              return (
                                (t.prev = 18),
                                (t.t0 = t.catch(0)),
                                console.error("Error fetching stories:", t.t0),
                                t.abrupt("return", [])
                              );
                            case 22:
                            case "end":
                          ...
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (
                                ...
                                (i =
                                  "https://story-api.dicoding.dev/v1/stories/".concat(
                                    e
                                  )),
                                (o = n
                                ...
                                (t.prev = 3),
                                (t.next = 6),
                                fetch(i, { method: "GET", headers: o })
                              );
                            case 6:
                              return (r = t.sent), (t.next = 9), r.json();
                            case 9:
                              if ((a = t.sent).error) {
                                t.next = 14;
                                break;
                              }
                              return t.abrupt("return", a.story);
                            case 14:
                              return (
                                console.error(
        ...
        function b(t, e) {
          function n(o, r, a, s) {
            ...
            if ("throw" !== l.type) {
              var u = l.arg,
                h = u.value;
              return h && "object" == I(h) && i.call(h, "__await")
                ? e.resolve(h.__await).then(
                    function (t) {
                      n("next", t, a, s);
                    },
        ...
        return (
          ...
          (e = [
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 3:
                            (e = t.sent), this.view.displayStories(e);
                          case 5:
                          case "end":
                            return t.stop();
                        }
            ...
            },
            {
              ...
              value: function (t) {
                var e = this;
                this.model.getStoryById(t).then(function (t) {
                  t
                    ? e.detailView.showStoryPopup(t)
                    : e.detailView.showError("Cerita tidak ditemukan.");
                });
              },
            },
            {
          ...
          (e = [
            {
              ...
              value: function () {
                var t = localStorage.getItem("token"),
                  e = localStorage.getItem("name") || "Guest",
                  n = !!t,
                  i = "true" === localStorage.getItem("isSubscribed");
                (this.container.innerHTML =
                  '\n    <div class="nav-brand">📖 Berbagi CeritaKu</div>\n    <nav class="nav-main">\n      <a href="#/home" id="home">Home</a>\n      <a href="#/add" id="tambah">Tambah Cerita</a>\n      '
                    ...
                    .concat(
                      n
                        ? "<span>👋 Hi, ".concat(
                            e,
                            '</span><a href="#" id="logout">Logout</a>'
                          )
            ...
            },
            {
              ...
              value: function (t) {
                var e = this,
                  ...
                  o = "true" === localStorage.getItem("isSubscribed");
                this.container.innerHTML =
                  '\n      <div class="nav-brand">📖 Berbagi CeritaKu</div>\n      <nav class="nav-main">\n        <a href="#/home" id="home">Home</a>\n        <a href="#/add" id="tambah">Tambah Cerita</a>\n        '
                    .concat(
                      i
                ...
                var r = document.getElementById("logout");
                r &&
            ...
            },
            {
              ...
              value: function () {
                var t = this,
                  ...
                  i = document.querySelector(".close-mobile-menu");
                ...
                var o = document.getElementById("mobileLogout");
                o &&
                ...
                var r = document.getElementById("mobileLogin");
                r &&
                  r.addEventListener("click", function () {
                    (location.hash = "#/login"), e.classList.add("hidden");
                  });
                var a = document.getElementById("subscribeBtn");
                a && a.addEventListener("click", this.subscribeUser.bind(this));
                var s = document.getElementById("unsubscribeBtn");
                s &&
                  s.addEventListener("click", this.unsubscribeUser.bind(this));
                var l = document.getElementById("mobileSubscribeBtn");
                l && l.addEventListener("click", this.subscribeUser.bind(this));
                var u = document.getElementById("mobileUnsubscribeBtn");
                u &&
                  u.addEventListener("click", this.unsubscribeUser.bind(this));
              },
            },
            {
              key: "subscribeUser",
                          ...
                          .then(function (e) {
                            console.log(
                              ...
                              e.pushManager
                                .subscribe({
                                  userVisibleOnly: !0,
                                  applicationServerKey: q(
                                    "BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk"
                                  ),
                                })
                                .then(function (e) {
                                  console.log("Berhasil subscribe:", e);
                                  var n = e.getKey("p256dh"),
                                    i = e.getKey("auth");
                                  n && i
                                    ? (fetch(
                                      ...
                                      t.render())
                                    : console.error(
                                        "Gagal: p256dh atau auth tidak valid."
                                      );
                                })
                                .catch(function (t) {
                                  console.log(
                                    "Gagal subscribe untuk push notification:",
                                    t
                                  );
                                });
                          })
                          .catch(function (t) {
                            console.log("Service Worker tidak siap:", t);
                          }))
                  ...
                  e.pushManager.getSubscription().then(function (e) {
                    e &&
                      e
                          ...
                          console.log("Berhasil unsubscribe"),
                            fetch(
                              "https://story-api.dicoding.dev/v1/notifications/subscribe",
                              {
                                ...
                                body: JSON.stringify({ endpoint: e.endpoint }),
                              }
                            )
                              .then(function (t) {
                                return t.json();
                              ...
                              .then(function (t) {
                                console.log("Unsubscription berhasil:", t);
                              })
                              .catch(function (t) {
                                console.log(
                                  "Gagal mengirim unsubscription ke server:",
                                  t
                                );
                              }),
                        ...
                        .catch(function (t) {
                          console.log("Gagal unsubscribe:", t);
                        });
                  });
                });
              },
      ...
      function W(t) {
        for (
          var e = "", n = new Uint8Array(t), i = n.byteLength, o = 0;
          o < i;
          o++
        )
              ...
              value: function () {
                ...
                document
                  ...
                  .addEventListener("submit", function (e) {
                    ...
                    t.onSubmitCallback && t.onSubmitCallback(n, i);
                  });
              },
            },
            {
      ...
      const { toString: Q } = Object.prototype,
        ...
        { iterator: et, toStringTag: nt } = Symbol,
        it =
          ((ot = Object.create(null)),
          (t) => {
            const e = Q.call(t);
            return ot[e] || (ot[e] = e.slice(8, -1).toLowerCase());
          });
      var ot;
      const rt = (t) => ((t = t.toLowerCase()), (e) => it(e) === t),
        at = (t) => (e) => typeof e === t,
        { isArray: st } = Array,
        lt = at("undefined"),
        ut = rt("ArrayBuffer"),
        ...
        ht = at("function"),
        dt = at("number"),
        ft = (t) => null !== t && "object" == typeof t,
        pt = (t) => {
          if ("object" !== it(t)) return !1;
          const e = tt(t);
          return !(
            (null !== e &&
              e !== Object.prototype &&
      ...
      const Lt =
        ...
        Tt = (t) => !lt(t) && t !== Lt,
        St =
          ((Ot = "undefined" != typeof Uint8Array && tt(Uint8Array)),
          (t) => Ot && t instanceof Ot);
      var Ot;
      const zt = rt("HTMLFormElement"),
        Ct = (
          ({ hasOwnProperty: t }) =>
          (e, n) =>
            t.call(e, n)
        ...
        jt = rt("AsyncFunction"),
        It =
          ((Bt = "function" == typeof setImmediate),
          (Rt = ht(Lt.postMessage)),
          Bt
            ? setImmediate
            : Rt
            ? ((Zt = `axios@${Math.random()}`),
              (Nt = []),
              Lt.addEventListener(
                "message",
                ({ source: t, data: e }) => {
                  t === Lt && e === Zt && Nt.length && Nt.shift()();
                },
                !1
              ),
              (t) => {
                Nt.push(t), Lt.postMessage(Zt, "*");
              })
            : (t) => setTimeout(t));
      var Bt, Rt, Zt, Nt;
      const Dt =
          "undefined" != typeof queueMicrotask
            ...
            : ("undefined" != typeof process && process.nextTick) || It,
        Ft = {
          isArray: st,
          isArrayBuffer: ut,
          isBuffer: function (t) {
          ...
          freezeMethods: (t) => {
            At(t, (e, n) => {
              if (ht(t) && -1 !== ["arguments", "caller", "callee"].indexOf(n))
                return !1;
              const i = t[n];
              ht(i) &&
                ((e.enumerable = !1),
          ...
          toObjectSet: (t, e) => {
            ...
            return st(t) ? i(t) : i(String(t).split(e)), n;
          },
          toCamelCase: (t) =>
            t
              .toLowerCase()
          ...
          isSpecCompliantForm: function (t) {
            return !!(t && ht(t.append) && "FormData" === t[nt] && t[et]);
          },
          toJSONObject: (t) => {
          ...
          isAsyncFn: jt,
          isThenable: (t) => t && (ft(t) || ht(t)) && ht(t.then) && ht(t.catch),
          setImmediate: It,
          asap: Dt,
          isIterable: (t) => null != t && ht(t[et]),
        };
      ...
      const Wt = Ut;
      function qt(t) {
        return Ft.isPlainObject(t) || Ft.isArray(t);
      }
      function Vt(t) {
        return Ft.endsWith(t, "[]") ? t.slice(0, -2) : t;
      }
      function Kt(t, e, n) {
        return t
          ? t
      ...
      const Jt = Ft.toFlatObject(Ft, {}, null, function (t) {
          return /^is[A-Z]/.test(t);
        }),
        Yt = function (t, e, n) {
          if (!Ft.isObject(t)) throw new TypeError("target must be an object");
          e = e || new FormData();
          const i = (n = Ft.toFlatObject(
              n,
              { metaTokens: !0, dots: !1, indexes: !1 },
              !1,
              function (t, e) {
                return !Ft.isUndefined(e[t]);
              }
            )).metaTokens,
            o = n.visitor || u,
            r = n.dots,
            ...
            s =
              ...
              Ft.isSpecCompliantForm(e);
          if (!Ft.isFunction(o))
            throw new TypeError("visitor must be a function");
          function l(t) {
            if (null === t) return "";
            if (Ft.isDate(t)) return t.toISOString();
            if (!s && Ft.isBlob(t))
              throw new Wt("Blob is not supported. Use a Buffer instead.");
            return Ft.isArrayBuffer(t) || Ft.isTypedArray(t)
          ...
          function u(t, n, o) {
            ...
            if (t && !o && "object" == typeof t)
              if (Ft.endsWith(n, "{}"))
                ...
                (Ft.isArray(t) &&
                  (function (t) {
                    return Ft.isArray(t) && !t.some(qt);
                  })(t)) ||
                ((Ft.isFileList(t) || Ft.endsWith(n, "[]")) &&
                  (s = Ft.toArray(t)))
              )
                return (
                  (n = Vt(n)),
                  s.forEach(function (t, i) {
                    !Ft.isUndefined(t) &&
                      null !== t &&
                      e.append(
                        !0 === a ? Kt([n], i, r) : null === a ? n : n + "[]",
                        l(t)
                      );
                  }),
                  !1
                );
            return !!qt(t) || (e.append(Kt(o, n, r), l(t)), !1);
          }
          const c = [],
            h = Object.assign(Jt, {
              defaultVisitor: u,
          ...
          if (!Ft.isObject(t)) throw new TypeError("data must be an object");
          return (
            (function t(n, i) {
              if (!Ft.isUndefined(n)) {
                if (-1 !== c.indexOf(n))
                ...
                c.push(n),
                  Ft.forEach(n, function (n, r) {
                    !0 ===
                      (!(Ft.isUndefined(n) || null === n) &&
                        o.call(e, n, Ft.isString(r) ? r.trim() : r, i, h)) &&
                      t(n, i ? i.concat(r) : [r]);
                  }),
                  c.pop();
              }
      ...
      function ne(t, e, n) {
        if (!e) return t;
        const i = (n && n.encode) || ee;
        Ft.isFunction(n) && (n = { serialize: n });
      ...
      const ie = class {
          ...
          forEach(t) {
            Ft.forEach(this.handlers, function (e) {
              null !== e && t(e);
            });
          }
        },
        ...
        se = ("object" == typeof navigator && navigator) || void 0,
        le =
          ae &&
          (!se ||
            ["ReactNative", "NativeScript", "NS"].indexOf(se.product) < 0),
        ue =
          "undefined" != typeof WorkerGlobalScope &&
          self instanceof WorkerGlobalScope &&
          "function" == typeof self.importScripts,
        ce = (ae && window.location.href) || "http://localhost",
        he = { ...t, ...re },
        de = function (t) {
          function e(t, n, i, o) {
            let r = t[o++];
            ...
            const a = Number.isFinite(+r),
              s = o >= t.length;
            return (
              (r = !r && Ft.isArray(i) ? i.length : r),
              s
                ? (Ft.hasOwnProp(i, r) ? (i[r] = [i[r], n]) : (i[r] = n), !a)
                : ((i[r] && Ft.isObject(i[r])) || (i[r] = []),
                  e(t, n, i[r], o) &&
                    Ft.isArray(i[r]) &&
                    (i[r] = (function (t) {
                      const e = {},
                      ...
                      const o = n.length;
                      let r;
                      for (i = 0; i < o; i++) (r = n[i]), (e[r] = t[r]);
                      return e;
                    })(i[r])),
                  !a)
            );
          }
          if (Ft.isFormData(t) && Ft.isFunction(t.entries)) {
            const n = {};
            return (
              Ft.forEachEntry(t, (t, i) => {
                e(
                  (function (t) {
                    return Ft.matchAll(/\w+|\[(\w*)]/g, t).map((t) =>
                      "[]" === t[0] ? "" : t[1] || t[0]
                    );
                  })(t),
                  i,
        ...
        fe = {
          ...
          transformRequest: [
            function (t, e) {
              const n = e.getContentType() || "",
                ...
                o = Ft.isObject(t);
              if (
                (o && Ft.isHTMLForm(t) && (t = new FormData(t)),
                Ft.isFormData(t))
              )
                return i ? JSON.stringify(de(t)) : t;
              if (
                Ft.isArrayBuffer(t) ||
                Ft.isBuffer(t) ||
                Ft.isStream(t) ||
                Ft.isFile(t) ||
                Ft.isBlob(t) ||
                Ft.isReadableStream(t)
              )
                return t;
              if (Ft.isArrayBufferView(t)) return t.buffer;
              if (Ft.isURLSearchParams(t))
                return (
                  e.setContentType(
                      ...
                      Object.assign(
                        {
                          visitor: function (t, e, n, i) {
                            return he.isNode && Ft.isBuffer(t)
              ...
              return o || i
                ? (e.setContentType("application/json", !1),
                  (function (t) {
                    if (Ft.isString(t))
                      try {
                        return (0, JSON.parse)(t), Ft.trim(t);
                      } catch (t) {
          ...
          transformResponse: [
            function (t) {
              const e = this.transitional || fe.transitional,
                n = e && e.forcedJSONParsing,
                i = "json" === this.responseType;
              if (Ft.isResponse(t) || Ft.isReadableStream(t)) return t;
              if (t && Ft.isString(t) && ((n && !this.responseType) || i)) {
      ...
      Ft.forEach(["delete", "get", "head", "post", "put", "patch"], (t) => {
        fe.headers[t] = {};
      });
      const pe = fe,
        me = Ft.toObjectSet([
      ...
      class be {
        ...
        set(t, e, n) {
          ...
          const r = (t, e) => Ft.forEach(t, (t, n) => o(t, n, e));
          if (Ft.isPlainObject(t) || t instanceof this.constructor) r(t, e);
          else if (
            Ft.isString(t) &&
            (t = t.trim()) &&
          ...
          else if (Ft.isObject(t) && Ft.isIterable(t)) {
            let n,
              i,
              o = {};
            for (const e of t) {
        ...
        get(t, e) {
          if ((t = _e(t))) {
            ...
            if (n) {
              ...
              if (Ft.isFunction(e)) return e.call(this, t, n);
              if (Ft.isRegExp(e)) return e.exec(t);
        ...
        has(t, e) {
          if ((t = _e(t))) {
            const n = Ft.findKey(this, t);
            return !(!n || void 0 === this[n] || (e && !ye(0, this[n], n, e)));
          }
          return !1;
        }
        delete(t, e) {
          ...
          function o(t) {
            if ((t = _e(t))) {
              const o = Ft.findKey(n, t);
              !o || (e && !ye(0, n[o], o, e)) || (delete n[o], (i = !0));
            }
          }
          return Ft.isArray(t) ? t.forEach(o) : o(t), i;
        }
        clear(t) {
          ...
          for (; n--; ) {
            const o = e[n];
            (t && !ye(0, this[o], o, t, !0)) || (delete this[o], (i = !0));
          }
          return i;
        }
        normalize(t) {
          ...
          return (
            Ft.forEach(this, (i, o) => {
              const r = Ft.findKey(n, o);
              if (r) return (e[r] = ve(i)), void delete e[o];
              const a = t
                ? (function (t) {
                    return t
                      .trim()
        ...
        static accessor(t) {
          const e = (this[ge] = this[ge] = { accessors: {} }).accessors,
            n = this.prototype;
          function i(t) {
            const i = _e(t);
            e[i] ||
              ((function (t, e) {
                const n = Ft.toCamelCase(" " + e);
          ...
          return Ft.isArray(t) ? t.forEach(i) : i(t), this;
        }
      }
      be.accessor([
        "Content-Type",
        ...
        Ft.reduceDescriptors(be.prototype, ({ value: t }, e) => {
      ...
      function xe(t, e) {
        ...
        let r = i.data;
        return (
          Ft.forEach(t, function (t) {
            r = t.call(n, r, o.normalize(), e ? e.status : void 0);
          }),
          o.normalize(),
          r
        );
      ...
      function Pe(t, e, n) {
        Wt.call(this, null == t ? "canceled" : t, Wt.ERR_CANCELED, e, n),
          (this.name = "CanceledError");
      }
      Ft.inherits(Pe, Wt, { __CANCEL__: !0 });
      const ke = Pe;
      function Le(t, e, n) {
      ...
      const Te = (t, e, n = 3) => {
        ...
        ze = he.hasStandardBrowserEnv
          ...
          : () => !0,
        Ce = he.hasStandardBrowserEnv
          ? {
              write(t, e, n, i, o, r) {
                const a = [t + "=" + encodeURIComponent(e)];
                Ft.isNumber(n) &&
                  a.push("expires=" + new Date(n).toGMTString()),
                  Ft.isString(i) && a.push("path=" + i),
                  Ft.isString(o) && a.push("domain=" + o),
                  !0 === r && a.push("secure"),
      ...
      const Ae = (t) => (t instanceof we ? { ...t } : t);
      function je(t, e) {
        e = e || {};
        const n = {};
        function i(t, e, n, i) {
          return Ft.isPlainObject(t) && Ft.isPlainObject(e)
            ? Ft.merge.call({ caseless: i }, t, e)
            : Ft.isPlainObject(e)
            ? Ft.merge({}, e)
            : Ft.isArray(e)
            ? e.slice()
        ...
        function r(t, e) {
          if (!Ft.isUndefined(e)) return i(void 0, e);
        }
        function a(t, e) {
          return Ft.isUndefined(e)
            ? Ft.isUndefined(t)
        ...
        function s(n, o, r) {
          return r in e ? i(n, o) : r in t ? i(void 0, n) : void 0;
        }
        const l = {
          url: r,
          method: r,
          ...
          responseEncoding: a,
          validateStatus: s,
          headers: (t, e, n) => o(Ae(t), Ae(e), 0, !0),
        };
        return (
          Ft.forEach(Object.keys(Object.assign({}, t, e)), function (i) {
            const r = l[i] || o,
              a = r(t[i], e[i], i);
            (Ft.isUndefined(a) && r !== s) || (n[i] = a);
          }),
          n
        );
      }
      const Ie = (t) => {
          ...
          if (
            ((e.headers = s = we.from(s)),
            (e.url = ne(
              Me(e.baseURL, e.url, e.allowAbsoluteUrls),
              t.params,
              t.paramsSerializer
            )),
            l &&
          ...
          if (
            ...
            (o && Ft.isFunction(o) && (o = o(e)), o || (!1 !== o && ze(e.url)))
          ) {
            const t = r && a && Ce.read(a);
            t && s.set(r, t);
          }
          return e;
        },
        Be =
          ...
          function (t) {
            return new Promise(function (e, n) {
              const i = Ie(t);
              let o = i.data;
              const r = we.from(i.headers).normalize();
              let a,
                s,
                l,
                u,
              ...
              m.open(i.method.toUpperCase(), i.url, !0),
                ...
                (m.onabort = function () {
                  m &&
                    (n(new Wt("Request aborted", Wt.ECONNABORTED, t, m)),
                    (m = null));
                }),
                (m.onerror = function () {
                  n(new Wt("Network Error", Wt.ERR_NETWORK, t, m)), (m = null);
                }),
                (m.ontimeout = function () {
                  let e = i.timeout
                    ? "timeout of " + i.timeout + "ms exceeded"
                    : "timeout exceeded";
                  const o = i.transitional || oe;
                  i.timeoutErrorMessage && (e = i.timeoutErrorMessage),
                    n(
                      new Wt(
                        e,
                        o.clarifyTimeoutError ? Wt.ETIMEDOUT : Wt.ECONNABORTED,
                        t,
                        m
                      )
                    ),
                ...
                "setRequestHeader" in m &&
                  Ft.forEach(r.toJSON(), function (t, e) {
                    m.setRequestHeader(e, t);
                  }),
                Ft.isUndefined(i.withCredentials) ||
                  (m.withCredentials = !!i.withCredentials),
                h && "json" !== h && (m.responseType = i.responseType),
                f && (([l, c] = Te(f, !0)), m.addEventListener("progress", l)),
                d &&
                  m.upload &&
                  (([s, u] = Te(d)),
        ...
        Re = (t, e) => {
          ...
          if (e || n) {
            ...
            const o = function (t) {
              if (!n) {
                ...
                i.abort(
                  e instanceof Wt
                    ? e
                    : new ke(e instanceof Error ? e.message : e)
                );
              }
            };
            let r =
              ...
              setTimeout(() => {
                (r = null),
                  o(new Wt(`timeout ${e} of ms exceeded`, Wt.ETIMEDOUT));
              }, e);
            const a = () => {
              t &&
                (r && clearTimeout(r),
            ...
            const { signal: s } = i;
            return (s.unsubscribe = () => Ft.asap(a)), s;
          }
        },
        Ze = function* (t, e) {
          let n = t.byteLength;
        ...
        Fe = De && "function" == typeof ReadableStream,
        Ue =
          De &&
          ("function" == typeof TextEncoder
            ? ((He = new TextEncoder()), (t) => He.encode(t))
      ...
      const Ge = (t, ...e) => {
        ...
        qe = Fe && Ge(() => Ft.isReadableStream(new Response("").body)),
        Ve = { stream: qe && ((t) => t.body) };
      var Ke;
      De &&
        ((Ke = new Response()),
        ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((t) => {
          !Ve[t] &&
            (Ve[t] = Ft.isFunction(Ke[t])
              ? (e) => e[t]()
              : (e, n) => {
                  throw new Wt(
          ...
          (async (t) => {
            ...
            try {
              if (
                ...
                0 !==
                  (g = await (async (t, e) => {
                    const n = Ft.toFiniteNumber(t.getContentLength());
                    return null == n
                      ? (async (t) => {
                          if (null == t) return 0;
                          if (Ft.isBlob(t)) return t.size;
                          if (Ft.isSpecCompliantForm(t)) {
                            const e = new Request(he.origin, {
                              method: "POST",
                              body: t,
                            });
                          ...
                          return Ft.isArrayBufferView(t) || Ft.isArrayBuffer(t)
                            ? t.byteLength
                            : (Ft.isURLSearchParams(t) && (t += ""),
                              Ft.isString(t)
                                ? (await Ue(t)).byteLength
                                : void 0);
                        })(e)
                      : n;
                  })(c, i))
                ...
                if (
                  ...
                  const [t, e] = Se(g, Te(Oe(l)));
                  i = Ne(n.body, 65536, t, e);
                }
              }
              Ft.isString(h) || (h = h ? "include" : "omit");
              ...
              let r = await fetch(f);
              const a = qe && ("stream" === u || "response" === u);
              if (qe && (s || (a && m))) {
                const t = {};
                ["status", "statusText", "headers"].forEach((e) => {
                  t[e] = r[e];
                });
                const e = Ft.toFiniteNumber(r.headers.get("content-length")),
                  [n, i] = (s && Se(e, Te(Oe(s), !0))) || [];
                r = new Response(
                  Ne(r.body, 65536, n, () => {
                    i && i(), m && m();
                  }),
              ...
              u = u || "text";
              let _ = await Ve[Ft.findKey(Ve, u) || "text"](r, t);
              return (
                !a && m && m(),
                await new Promise((e, n) => {
                  Le(e, n, {
                    data: _,
                    headers: we.from(r.headers),
                    status: r.status,
              ...
              if (
                ...
                throw Object.assign(
                  new Wt("Network Error", Wt.ERR_NETWORK, t, f),
                  { cause: e.cause || e }
                );
              throw Wt.from(e, e && e.code, t, f);
            }
          }),
        Ye = { http: null, xhr: Be, fetch: Je };
      Ft.forEach(Ye, (t, e) => {
        if (t) {
          try {
      ...
      const Xe = (t) => `- ${t}`,
        $e = (t) => Ft.isFunction(t) || null === t || !1 === t,
        Qe = (t) => {
          t = Ft.isArray(t) ? t : [t];
          const { length: e } = t;
          let n, i;
          ...
          for (let r = 0; r < e; r++) {
            ...
            if (
              ((n = t[r]),
              (i = n),
              !$e(n) && ((i = Ye[(e = String(n)).toLowerCase()]), void 0 === i))
            )
              throw new Wt(`Unknown adapter '${e}'`);
            if (i) break;
            o[e || "#" + r] = i;
          }
          if (!i) {
      ...
      function en(t) {
        return (
          ...
          Qe(t.adapter || pe.adapter)(t).then(
            function (e) {
              return (
                tn(t),
          ...
          assertOptions: function (t, e, n) {
            ...
            for (; o-- > 0; ) {
              ...
              if (a) {
                ...
                throw new Wt("Unknown option " + r, Wt.ERR_BAD_OPTION);
            }
          },
          validators: nn,
        },
      ...
      class sn {
        ...
        _request(t, e) {
          ...
          let r = o && Ft.merge(o.common, o[e.method]);
          o &&
            Ft.forEach(
        ...
        getUri(t) {
          return ne(
            Me((t = je(this.defaults, t)).baseURL, t.url, t.allowAbsoluteUrls),
            t.params,
            t.paramsSerializer
          );
        }
      ...
      Ft.forEach(["delete", "get", "head", "options"], function (t) {
        sn.prototype[t] = function (e, n) {
          return this.request(
            je(n || {}, { method: t, url: e, data: (n || {}).data })
          );
        };
      }),
      ...
      class un {
        constructor(t) {
          ...
          this.promise.then((t) => {
            ...
            t(function (t, i, o) {
              n.reason || ((n.reason = new ke(t, i, o)), e(n.reason));
            });
        }
        throwIfRequested() {
      ...
      const dn = hn,
        fn = (function t(e) {
          const n = new ln(e),
            i = $(ln.prototype.request, n);
          return (
            Ft.extend(i, ln.prototype, n, { allOwnKeys: !0 }),
            Ft.extend(i, n, null, { allOwnKeys: !0 }),
            (i.create = function (n) {
              return t(je(e, n));
            }),
            i
      ...
      (fn.Axios = ln),
        ...
        (fn.isAxiosError = function (t) {
          return Ft.isObject(t) && !0 === t.isAxiosError;
        }),
        (fn.mergeConfig = je),
        (fn.AxiosHeaders = we),
        (fn.formToJSON = (t) => de(Ft.isHTMLForm(t) ? new FormData(t) : t)),
        (fn.getAdapter = Qe),
        (fn.HttpStatusCode = dn),
        (fn.default = fn);
      const pn = fn;
      function mn(t) {
        return (
      ...
      function gn() {
        ...
        function b(t, e) {
          function n(o, r, a, s) {
            ...
            if ("throw" !== l.type) {
              var u = l.arg,
                h = u.value;
              return h && "object" == mn(h) && i.call(h, "__await")
                ? e.resolve(h.__await).then(
                    function (t) {
                      n("next", t, a, s);
                    },
        ...
        function k(e) {
          ...
          throw new TypeError(mn(e) + " is not iterable");
        }
        return (
          (f.prototype = p),
          l(v, "constructor", p),
      ...
      function vn(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            "value" in i && (i.writable = !0),
            Object.defineProperty(t, yn(i.key), i);
        }
      }
      function yn(t) {
        var e = (function (t) {
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              (t.prev = 0),
                              (t.next = 3),
                              pn.post(this.apiUrl, { email: e, password: n })
                            );
                          case 3:
                            if (!1 !== (i = t.sent).data.error) {
                              t.next = 11;
                              break;
                            }
                            return (
                              (o = i.data.loginResult),
                              (r = o.token),
                              (a = o.name),
                          ...
                          case 14:
                            return (
                              (t.prev = 14),
                              (t.t0 = t.catch(0)),
                              console.error("Login failed:", t.t0),
                              t.abrupt("return", !1)
                            );
                          case 18:
                          case "end":
      ...
      function En() {
        ...
        function b(t, e) {
          function n(o, r, a, s) {
            ...
            if ("throw" !== l.type) {
              var u = l.arg,
                h = u.value;
              return h && "object" == xn(h) && i.call(h, "__await")
                ? e.resolve(h.__await).then(
                    function (t) {
                      n("next", t, a, s);
                    },
        ...
        function k(e) {
          ...
          throw new TypeError(xn(e) + " is not iterable");
        }
        return (
          (f.prototype = p),
          l(v, "constructor", p),
      ...
      function kn(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            "value" in i && (i.writable = !0),
            Object.defineProperty(t, Ln(i.key), i);
        }
      }
      function Ln(t) {
        var e = (function (t) {
        ...
        return (
          ...
          (e = [
            ...
            },
            {
              key: "handleSubmit",
              value:
                ((n = En().mark(function t(e, n) {
                  return En().wrap(
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (t.next = 2), this.model.login(e, n);
                          case 2:
                            t.sent
      ...
      function An(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            "value" in i && (i.writable = !0),
            Object.defineProperty(t, jn(i.key), i);
        }
      }
      function jn(t) {
        var e = (function (t) {
      ...
      (Cn.styleTagTransform = f()),
        (Cn.setAttributes = u()),
        (Cn.insert = s().bind(null, "head")),
        (Cn.domAPI = r()),
        (Cn.insertStyleElement = h()),
        i()(zn.A, Cn),
          ...
          (e = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  (On().Icon.Default.mergeOptions({
                    iconRetinaUrl: "".concat(e, "images/marker-icon-2x.png"),
                    iconUrl: "".concat(e, "images/marker-icon.png"),
                    shadowUrl: "".concat(e, "images/marker-shadow.png"),
                  }),
                  n)
                ) {
                  var i = On().map(n).setView([-6.1751, 106.865], 13);
                  On()
                    .tileLayer(
                    ...
                    i.on("click", function (e) {
                      var n = e.latlng.lat,
                        o = e.latlng.lng;
                      t.selectedMarker && i.removeLayer(t.selectedMarker),
                        (t.selectedMarker = On()
                          .marker([n, o])
                          .addTo(i)
              ...
              value: function () {
                ...
                document
                  ...
                  document
                    ...
                    .addEventListener("submit", function (e) {
                      e.preventDefault();
                      var n = document.getElementById("description").value,
                        i = t.getPhotoData(),
                        o = t.selectedLat,
                        r = t.selectedLon;
                      t.onSubmit && t.onSubmit(n, i, o, r);
                    });
                    ...
                    .then(function (n) {
                      (t.stream = n),
                        ...
                        (e.onloadedmetadata = function () {
                          var t = document.getElementById("snapshot");
                          (t.width = e.videoWidth), (t.height = e.videoHeight);
                        });
                    })
                    .catch(function (e) {
                      t.showError("Tidak bisa mengakses kamera: " + e.message);
                    });
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                var t = document.getElementById("camera"),
                  e = document.getElementById("snapshot"),
                  n = e.getContext("2d");
            ...
            },
            {
              ...
              value: function () {
                var t = document.getElementById("snapshot");
                if ("block" === t.style.display) return t.toDataURL();
                var e = document.getElementById("file");
                return e && e.files.length > 0 ? e.files[0] : null;
              },
            },
            {
              key: "showError",
      ...
      function Rn() {
        ...
        function b(t, e) {
          function n(o, r, a, s) {
            ...
            if ("throw" !== l.type) {
              var u = l.arg,
                h = u.value;
              return h && "object" == Bn(h) && i.call(h, "__await")
                ? e.resolve(h.__await).then(
                    function (t) {
                      n("next", t, a, s);
                    },
        ...
        function k(e) {
          ...
          throw new TypeError(Bn(e) + " is not iterable");
        }
        return (
          (f.prototype = p),
          l(v, "constructor", p),
      ...
      function Fn(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            "value" in i && (i.writable = !0),
            Object.defineProperty(t, Un(i.key), i);
        }
      }
      function Un(t) {
        var e = (function (t) {
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            if (
                              ((r = new FormData()).append("description", e),
                              !n)
                            ) {
                              t.next = 13;
                              break;
                          ...
                          case 13:
                            return (
                              ...
                              (u = this.token
                                ...
                                : { "Content-Type": "multipart/form-data" }),
                              (t.next = 20),
                              pn.post(l, r, { headers: u })
                            );
                          case 20:
                            if ((c = t.sent).data.error) {
                              t.next = 24;
                              break;
                            }
                            return (
                          ...
                          case 28:
                            return (
                              ...
                              t.t0.response
                                ...
                                : console.error("Error message:", t.t0.message),
                              t.abrupt("return", !1)
                            );
                          case 32:
                          case "end":
        ...
        function b(t, e) {
          function n(o, r, a, s) {
            ...
            if ("throw" !== l.type) {
              var u = l.arg,
                h = u.value;
              return h && "object" == Gn(h) && i.call(h, "__await")
                ? e.resolve(h.__await).then(
                    function (t) {
                      n("next", t, a, s);
                    },
      ...
      function Vn(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            "value" in i && (i.writable = !0),
            Object.defineProperty(t, Kn(i.key), i);
        }
      }
      function Kn(t) {
        var e = (function (t) {
                        ...
                        switch ((t.prev = t.next)) {
                          ...
                          case 11:
                            (t.prev = 11),
                              (t.t0 = t.catch(4)),
                              this.view.showError(
                                "Terjadi kesalahan saat mengupload cerita."
                              );
                          case 14:
                            (this.isSubmitting = !1),
                              (document.getElementById("upload-btn").disabled =
          ...
          (e = [
            ...
            },
            {
              ...
              value: function (t, e, n) {
                throw new Error(
                  "onRegister method must be implemented in the presenter"
                );
              },
            },
            {
      ...
      function ei() {
        ...
        function b(t, e) {
          function n(o, r, a, s) {
            ...
            if ("throw" !== l.type) {
              var u = l.arg,
                h = u.value;
              return h && "object" == ti(h) && i.call(h, "__await")
                ? e.resolve(h.__await).then(
                    function (t) {
                      n("next", t, a, s);
                    },
        ...
        function k(e) {
          ...
          throw new TypeError(ti(e) + " is not iterable");
        }
        return (
          (f.prototype = p),
          l(v, "constructor", p),
      ...
      function ii(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            "value" in i && (i.writable = !0),
            Object.defineProperty(t, oi(i.key), i);
        }
      }
      function oi(t) {
        var e = (function (t) {
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              (o = { name: e, email: n, password: i }),
                              (t.prev = 1),
                              (t.next = 4),
                              pn.post(this.apiUrl, o)
                            );
                          case 4:
                            if ((r = t.sent).data.error) {
                              t.next = 8;
                              break;
                            }
                            return (
                          ...
                          case 12:
                            return (
                              (t.prev = 12),
                              (t.t0 = t.catch(1)),
                              console.error("Error during registration:", t.t0),
                              t.abrupt("return", !1)
                            );
                          case 16:
                          case "end":
        ...
        function b(t, e) {
          function n(o, r, a, s) {
            ...
            if ("throw" !== l.type) {
              var u = l.arg,
                h = u.value;
              return h && "object" == ai(h) && i.call(h, "__await")
                ? e.resolve(h.__await).then(
                    function (t) {
                      n("next", t, a, s);
                    },
      ...
      function ui(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            "value" in i && (i.writable = !0),
            Object.defineProperty(t, ci(i.key), i);
        }
      }
      function ci(t) {
        var e = (function (t) {
        ...
        return (
          ...
          (e = [
            ...
            },
            {
              key: "handleRegister",
              value:
                ((n = si().mark(function t(e, n, i) {
                  return si().wrap(
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (t.next = 2), this.model.register(e, n, i);
                          case 2:
                            t.sent
      ...
      function fi(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            "value" in i && (i.writable = !0),
            Object.defineProperty(t, pi(i.key), i);
        }
      }
      function pi(t) {
        var e = (function (t) {
      ...
      var vi = new V();
      vi.render(),
        (window.viewStoryDetail = function (t) {
          bi.showStoryDetail(t);
        }),
      ...
      var wi = function () {
          ...
          vi.render(),
            t
              ? vi.updateHeader(e, "Logout", Ei)
              : vi.updateHeader("Guest", "Login", Pi);
        },
        xi = function () {
          var t = localStorage.getItem("token"),
            e = location.hash.slice(1).toLowerCase() || "#/";
          (t || "/login" === e || "/register" === e) &&
            (yi.handleRoute(), wi());
        };
      wi();
      var Ei = function () {
      ...
      window.addEventListener("hashchange", xi),
        window.addEventListener("load", xi),
        document
        ...
        "serviceWorker" in navigator &&
          window.addEventListener("load", function () {
            navigator.serviceWorker
              ...
              .then(function (t) {
                return console.log("Service Worker registered:", t);
              })
              .catch(function (t) {
                return console.error("Service Worker registration failed:", t);
              });
          });
    })();
})();
